...
class Order(models.Model):
    ...
    total = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='MXN Order Total')
...
class OrderItem(models.Model):
    ...
    quantity = models.IntegerField()
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='MXN Price')
